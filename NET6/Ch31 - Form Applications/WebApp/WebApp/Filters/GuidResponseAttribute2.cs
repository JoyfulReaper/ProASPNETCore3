...
namespace WebApp.Filters
{
    ...
    public class GuidResponse2Attribute : Attribute, IAsyncAlwaysRunResultFilter, IFilterFactory
    {
        ...
        {
            return ActivatorUtilities.GetServiceOrCreateInstance<GuidResponse2Attribute>(serviceProvider);
        }
